...
## Methodologie
In de eerste **discoverfase** werd de opdracht verkend: wat is het doel van de opdracht? Welke problemen doen zich voor, en kunnen deze gekoppeld worden aan bestaande oplossingen? Deze opdracht startte met het verkennen van de designchallenge Werkbaar Werk in de Zorg, met de bijbehorende noden en behoeften [^5].
User interviews bevestigden dat stress op de werkvloer een groot probleem is. Literatuuronderzoek toonde aan dat burn-outs een aanzienlijk risico vormen, terwijl methoden zoals de 5WH-methode en PESTEL-analyse hielpen om kerninzichten te identificeren.

In de **definitiefase** werd het probleem verder verkend via een meer praktische aanpak, rekening houdend met het principe "fall in love with the problem, not the solution." Tijdens deze fase werden de eerste prototypes ontwikkeld en zo snel mogelijk getest op hun levensvatbaarheid voor verdere verfijning. Dit gebeurde in een vroege concepttest met verpleegkundigen in WZC Altus. De feedback uit deze testfase werd verwerkt in een verbeterde prototypeversie, die gedurende een week werd getest bij VZW De Oever. Aan het einde van deze testperiode werd een groepsinterview georganiseerd om alle relevante feedback te verzamelen. De verkregen data diende als basis voor de verdere verfijning van de design requirements, zodat het uiteindelijke ontwerp beter zou aansluiten bij de behoeften en verwachtingen van de stakeholders.

In de **ontwikkelfase** werd het concept verder verfijnd door middel van diverse gebruikerstesten, waarbij principes zoals het Think Aloud-principe, Wizard of OZ-prototypes en andere methodieken centraal stonden. Deze theoretische kapstokken maakten het mogelijk om constructief aan de slag te gaan met het in kaart brengen van de echte noden van de gebruikers.

De ontwikkeling van deze prototypes vond plaats tijdens ideation-sessies, waarin methodes zoals brainstorming en rollenspellen werden toegepast. Aansluitend werden de prototypes getest in verschillende WZC. Tijdens deze testsessies werden methodes zoals Emotional Mapping met Plutchik’s Wheel of Emotions, card sorting, en andere technieken toegepast om de emoties van de gebruikers duidelijk in kaart te brengen, zodat de meest relevante emoties geselecteerd konden worden. De verzamelde data werd vervolgens geëvalueerd met technieken als dot-voting en de MoSCoW-methode om inzichten te verkrijgen voor verdere optimalisatie.

Om de effectiviteit van verschillende ontwerpkeuzes te toetsen, werden onder andere A/B-testing, heuristic evaluation, SUS-surveys en observatie ingezet. Hiermee konden prototypes – of onderdelen ervan – doelgericht getest worden, wat waardevolle inzichten opleverde voor verdere verfijning en afstemming op de gebruikersbehoeften.

Tot slot werd een online enquête opgesteld ter verfijning van de visuele ontwerpkeuzes. Deze enquête is gefocust op de esthetische en visuele perceptie en werd breed toegankelijk verspreid via familie, kennissen en vrienden binnen verschillende leeftijdsgroepen. Methodologisch werd hierbij rekening gehouden met onder andere het query effect, waarbij antwoordopties en visuele inputs zorgvuldig werden gecontrasteerd om bias te vermijden. Voor de enquête werden verschillende ontwerpmethodes zoals desirability testing, preference testing, 5 second testing en veel andere toegepast. Deze methodes leverden snel inzicht op in de voorkeuren en esthetische beleving van de gebruikers. De resultaten vormden waardevolle input voor de selectie van stijl- en vormelementen in het uiteindelijke ontwerp.
