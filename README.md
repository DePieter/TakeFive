...
Daarnaast werd er een online enquête opgesteld ter verfijning van de ontwerpkeuzes. Deze enquête focuste op esthetische en visuele perceptie en werd breed toegankelijk verspreid via familie, kennissen en vrienden binnen verschillende leeftijdsgroepen. Methodologisch werd hierbij rekening gehouden met het query effect, waarbij antwoordopties en visuele inputs zorgvuldig werden gecontrasteerd om bias te vermijden. Voor de enquête werden verschillende ontwerpmethodes zoals desirability testing, preference testing, 5 second testing en zoveel andere toegepast. Deze methodes leverden snel inzicht op in de voorkeuren en esthetische beleving van de gebruikers. De resultaten vormden waardevolle input voor de selectie van stijl- en vormelementen in het uiteindelijke ontwerp.
