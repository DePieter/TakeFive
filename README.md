...
| ![image](https://github.com/user-attachments/assets/486e78fe-eb59-4ecd-9902-ced9acc7eaa7)| **Feedback unit (hoofdfocus):** Elke gebruiker heeft een eigen bloem op zijn/haar zorgkar staan. De bloem gaat slapper hangen naarmate het stressniveau toeneemt. Zodra de bloem volledig slap hangt zal de kleur van de bloempot rood kleuren, op die moment is het tijd om de bloem water te geven -> pauze nemen.|| ![image](https://github.com/user-attachments/assets/1c8149e4-277d-40a9-aa7e-0380b4c1f46c)
